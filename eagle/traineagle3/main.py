...
parser.add_argument('--preprocess_needed', action=argparse.BooleanOptionalAction, help="If you need to run build_dataset_rank place a True flag")
...
if args.preprocess_needed:
    ...
    fulldataset = load_dataset("json", data_files=args.trainpath)
